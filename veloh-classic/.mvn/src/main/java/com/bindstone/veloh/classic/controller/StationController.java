...
public class StationController {
    ...
    public ResponseEntity<List<StationDistanceDao>> findNext(@RequestParam Double lat, @RequestParam Double lng) {
        return ResponseEntity.ok(stationService.findNext(lat, lng));
    }
